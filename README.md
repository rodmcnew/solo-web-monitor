# Demo
[Try the demo](https://solo-web-monitor.herokuapp.com/demo/reset-database-and-redirect-home). Give the demo 60 seconds to first load because it is hosted on a free instance that falls asleep after a while.
